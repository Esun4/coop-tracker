      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div data-custom-class="body">
          ...
          <div style={{ lineHeight: 1.5 }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
              <span data-custom-class="body_text">
                This Privacy Notice for <strong>Jobtracker</strong> (&quot;
          ...
          <ul>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  <a
                    ...
                    href="https://coop-tracker1.vercel.app/"
                  >
                    https://coop-tracker1.vercel.app/
                  </a>{" "}
            ...
            <li data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
              <span style={{ fontSize: 15 }}>
                ...
                everything in between. It also connects to your Gmail to
                automatically detect application-related emails and surface them as
                suggestions, so you can keep your tracker up to date without manual
                data entry.
              </span>
            </li>
            <li data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
            ...
            <span style={{ fontSize: 15, color: "rgb(127, 127, 127)" }}>
              <span data-custom-class="body_text">
                ...
                <a
                  target="_blank"
                  data-custom-class="link"
                  href="mailto:ethansun44+security@gmail.com"
                >
                  ethansun44+security@gmail.com
                </a>
                .
              </span>
            </span>
          ...
          <div style={{ lineHeight: 1.5 }}>
            ...
            <a
              data-custom-class="link"
              href="https://app.termly.io/dsar/3c268ef0-1dc4-445b-aa69-6f565932eb0c"
          ...
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#infocollect"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>1. WHAT INFORMATION DO WE COLLECT?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#infouse"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>2. HOW DO WE PROCESS YOUR INFORMATION?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#legalbases"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#whoshare"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#ai"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>5. DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#sociallogins"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#inforetain"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>7. HOW LONG DO WE KEEP YOUR INFORMATION?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#infosafe"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>8. HOW DO WE KEEP YOUR INFORMATION SAFE?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#infominors"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>9. DO WE COLLECT INFORMATION FROM MINORS?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#privacyrights"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>10. WHAT ARE YOUR PRIVACY RIGHTS?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#DNT"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>11. CONTROLS FOR DO-NOT-TRACK FEATURES</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#policyupdates"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>12. DO WE MAKE UPDATES TO THIS NOTICE?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#contact"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span></a>
          </div>
          <div style={{ lineHeight: 1.5 }}>
            <a data-custom-class="link" href="#request"><span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span></a>
          </div>
          ...
          <ul>
            {["names", "email addresses", "usernames", "passwords"].map((item) => (
              <li key={item} data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">{item}</span>
                </span>
              </li>
            ))}
          </ul>
          ...
          <div id="sensitiveinfo" style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                consent or as otherwise permitted by applicable law, we process
          ...
          <div style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                account details. If you choose to register in this way, we will
                collect certain profile information about you from the social media
                provider, as described in the section{" "}
          ...
          <ul>
            {[
              ...
              <li key={i} data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
                <span data-custom-class="body_text" style={{ fontSize: 15 }}>
                  {item}
                </span>
              </li>
          ...
          <div style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                <strong>OpenAI</strong>. As outlined in this Privacy Notice, your
          ...
          <div style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                third-party social media account details (like your Google login).
          ...
          <div style={{ lineHeight: 1.5 }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                you become aware of any data we may have collected from children
                under age 18, please contact us at{" "}
                <a
                  target="_blank"
                  data-custom-class="link"
                  href="mailto:ethansun44@gmail.com"
                >
                  ethansun44@gmail.com
                </a>
                .
              </span>
            </span>
          ...
          <div id="DNT" style={{ lineHeight: 1.5 }}>
            ...
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                must follow in the future, we will inform you about that practice in
